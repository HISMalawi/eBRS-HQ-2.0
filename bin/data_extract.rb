...
PersonBirthDetail.find_each{|details|
  ...
  if mother_person_id.blank?
    ...
    m_home_ta           = location_map[mother_address.home_ta]
    m_home_village      = location_map[mother_address.home_village]

    m_cur_district      = location_map[mother_address.current_district]
    m_cur_ta            = location_map[mother_address.current_ta]
    m_cur_village       = location_map[mother_address.current_village]
  ...
  if father_person_id.blank?
    ...
    f_home_ta           = location_map[father_address.home_ta]
    f_home_village      = location_map[father_address.home_village]

    f_cur_district      = location_map[father_address.current_district]
    f_cur_ta            = location_map[father_address.current_ta]
    f_cur_village       = location_map[father_address.current_village]
