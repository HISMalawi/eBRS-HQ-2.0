...
mysqldump -u $USERNAME -p$PASSWORD  --no-create-info $DATABASE --tables core_person person_name users -w"person_id NOT LIKE '100271%'"  > tmp2.sql

mysqldump -u $USERNAME -p$PASSWORD  --no-create-info $DATABASE --tables user_role -w"user_id NOT LIKE '100271%'"  > tmp3.sql
